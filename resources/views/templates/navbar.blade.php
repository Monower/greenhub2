...
{{--         <a title="messages" class="btn btn-sm btn-primary" href="{{route('user.get_user_message')}}"><i class="bi bi-envelope-fill"></i></a>
        ...
        <ul class="navbar-nav me-auto">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><img src="{{asset('sadaf.jpg')}}" alt="" height="30" width="40" style="border-radius: 50%"></a>
